...
const ContentManagement = () => {
  ...
  const [confirmOpen, setConfirmOpen] = useState(false) //silme modalın açılması için 
  const [selectedId, setSelectedId] = useState(null); //silme modal için id
            ...
            <div className="flex items-center gap-2 overflow-x-auto pb-2 sm:pb-0 hide-scrollbar">
              {contentTypes.map(type => (
                <button
                  ...
                  className={`px-3 py-1.5 text-sm rounded-full cursor-pointer whitespace-nowrap ${activeType === type.id
        ...
        <div className="p-4 sm:p-6 flex flex-col sm:flex-row gap-4 items-start sm:items-center border-b border-gray-200">
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <div className="relative">
              <select
                className="appearance-none pl-3 pr-8 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 cursor-pointer sm:text-sm"
                value={sortOption}
                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <select
                          className="w-full border cursor-pointer border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500"
                      ...
                      <div className="flex justify-end space-x-2 pt-2">
                        ...
                        <button
                          className="px-3 py-2 text-sm cursor-pointer bg-indigo-600 text-white rounded hover:bg-indigo-700"
              ...
              <div>
                <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                  ...
                  <button
                    ...
                    className={`relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 cursor-pointer bg-white text-sm font-medium ${currentPage === 1
                  ...
                  <button
                    ...
                    className={`relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white cursor-pointer text-sm font-medium ${currentPage === totalPages
                        ? 'text-gray-300 cursor-not-allowed'
                        : 'text-gray-500 hover:bg-gray-50'
                      }`}
                  >
